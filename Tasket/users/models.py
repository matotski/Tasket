...
class Project(models.Model):
    ...
    status = models.CharField(
        max_length=50, choices=[("active", "Активен"), ("archived", "Архивирован")]
    )
...
class UserProjectRole(models.Model):
    ...
    role = models.ForeignKey(
        to=Role, max_length=150, on_delete=models.CASCADE, blank=True, null=True
    )
...
class Task(models.Model):
    ...
    tester = models.ForeignKey(
        to=UserProjectRole, on_delete=models.SET_NULL, blank=True, null=True
    )
